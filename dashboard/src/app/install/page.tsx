...
const ZIP_URL = "https://github.com/PugarHuda/nih/releases/download/v0.2.0/nih-extension-v0.2.0.zip";
      ...
      <main className="container max-w-3xl py-16">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <div className="inline-flex items-center gap-2 rounded-full border border-brand/30 bg-brand/5 px-3 py-1.5 text-xs text-brand mb-4">
            <Chrome className="h-3.5 w-3.5" /> Browser extension · v0.2.0
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-5">
            <div className="flex-1">
              <CardHeader className="pb-2">
                ...
                <CardDescription>1.1 MB · MV3 · open source · five platforms</CardDescription>
              </CardHeader>
            </div>
        ...
        <div className="space-y-3 mb-12">
          ...
          <StepRow
            ...
            body={
              <p className="text-sm text-muted">
                Unzip <code className="text-fg">nih-extension-v0.2.0.zip</code> on your
